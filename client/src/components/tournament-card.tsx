      ...
      >
        ...
        <div className="relative h-full flex flex-col">
          ...
          <div className="p-6 flex justify-between items-start">
            ...
            <div className="bg-white/90 backdrop-blur-sm border border-black/10 px-3 py-1 min-w-fit max-w-fit">
              <span className="text-xs font-mono font-medium text-black whitespace-nowrap block truncate">
